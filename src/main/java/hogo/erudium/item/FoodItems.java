...
public class FoodItems {
    ...
    public static final FoodProperties COFFEE = new FoodProperties.Builder().nutrition(2).effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 20*60*10,2),1f).effect(() -> new MobEffectInstance(MobEffects.NIGHT_VISION, 20*60*10,2),1f).effect(() -> new MobEffectInstance(MobEffects.HEALTH_BOOST, 20*60*10,14),1f).effect(() -> new MobEffectInstance(MobEffects.REGENERATION,60,255),1f).alwaysEat().saturationMod(5).build();
