...
public class HonzaModel<T extends HonzaEntity> extends SinglePartEntityModel<T> {

	private final ModelPart Honza;
	private final ModelPart Head;
	public HonzaModel(ModelPart root) {
		this.Honza = root.getChild("Vojta");
		this.Head = Honza.getChild("Head");
	}
	...
	@Override
	public void setAngles(HonzaEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {

		this.Honza.traverse().forEach(ModelPart::resetTransform); //IMPORTANT DO NOT REMOVE
	...
	public void render(MatrixStack matrices, VertexConsumer vertexConsumer, int light, int overlay, float red, float green, float blue, float alpha) {
		Honza.render(matrices, vertexConsumer, light, overlay, red, green, blue, alpha);
	}
